...
public class DiagramClass extends DiagramElement{
    private boolean updatedDimensions;
    
    public DiagramClass(ClassData classData) {
        super(classData);
    ...
    public void Draw(Graphics2D g2){
        ...
        Color accent = UmlTheme.ClassAccent;
        int currentY = drawClasslikeElementBox(g2, UmlTheme.ClassBackground, accent);
